/* API GATEWAY */
export const API_STAGE = process.env.REACT_APP_API_STAGE;
...
const TRANSFER_API_ENDPOINT = process.env.REACT_APP_TRANSFER_API_ENDPOINT;
...
export const TRANSFER_API_ENDPOINT_URL = `${TRANSFER_API_ENDPOINT}/${API_STAGE}`;
